    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSkilss", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserSkilss_Skills_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Skills",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserSkilss_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSkilss_SkillId",
                table: "UserSkilss",
                column: "SkillId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSkilss_UserId",
                table: "UserSkilss",
                column: "UserId");
        }
